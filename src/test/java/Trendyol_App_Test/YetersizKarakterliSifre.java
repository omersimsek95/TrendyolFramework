...
public class YetersizKarakterliSifre extends base{
	
	@Parameters({"gecerli_mail","gecerli_sifre"})
	@Test
	public void yetersizKarakterliSifre(String gecerli_mail, String gecerli_sifre) throws InterruptedException {
		...
		String actualMessage = "Şifreniz 6 - 16 karakter arasında olmalıdır.";
		String snackMessage = (String) hesabim.uyarı_sifre_karakter.getText();
